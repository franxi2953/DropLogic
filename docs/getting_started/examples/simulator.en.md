...
This script demonstrates a continuous multi-droplet workflow using the `Simulator` system.

It:

- creates 20 droplets
- assigns random origins and targets
- runs SIPP planning
- executes the resulting plan with visualizers enabled
- reassigns new random targets after each completed run
