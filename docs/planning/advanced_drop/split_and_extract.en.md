...
control and repeatability.<sup class="dl-cite dl-cite--right"><a href="#ref-hu-2022" aria-describedby="cite-hu-2022">1</a><span id="cite-hu-2022" class="dl-cite__preview" role="tooltip"><span class="dl-cite__label">Reference</span><span class="dl-cite__meta">APL 2022</span><strong class="dl-cite__title">A geometrical model of pinch-off in digital microfluidics underpins 'one-to-three' droplet generation</strong><span class="dl-cite__authors">C. Hu, H. Zhang, C. Jiang and H. Ma</span><span class="dl-cite__summary">Geometrical model explaining why one-to-three pinch-off can produce controlled daughter droplets in compact DMF layouts.</span></span></sup><sup class="dl-cite dl-cite--right"><a href="#ref-jin-2021" aria-describedby="cite-jin-2021">2</a><span id="cite-jin-2021" class="dl-cite__preview" role="tooltip"><span class="dl-cite__label">Reference</span><span class="dl-cite__meta">LOC 2021</span><strong class="dl-cite__title">'One-to-three' droplet generation in digital microfluidics for parallel chemiluminescence immunoassays</strong><span class="dl-cite__authors">K. Jin, C. Hu, S. Hu, C. Hu, J. Li and H. Ma</span><span class="dl-cite__summary">Experimental use of one-to-three droplet generation for parallel immunoassay workflows on a digital microfluidic platform.</span></span></sup>
